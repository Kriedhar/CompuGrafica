...
if __name__ == '__main__':
    ...
    while not fin:
        ...
        fondo.vel_x = 0
        if p1.rect.x <= 30 and fondo.rect.x < 0 and p1.move == 2:
            fondo.vel_x = vel
            p1.rect.x -= p1.vel_x
        ...
        if p1.rect.x+p1.rect.width >= 830 and fondo.rect.x >= (-6020+860) and p1.move == 1:
            fondo.vel_x =- vel
            p1.rect.x -= p1.vel_x
            p2.rect.x += fondo.vel_x
            if p2.move == 1:
        ...
        for u in usuarios:
            if u.rect.x <= 30:
                u.rect.x = 30
            if u.rect.x+u.rect.width >= 830:
                u.rect.x = 830-u.rect.width
